...
lab <- c("What to call my R package?", "Hmm... What? raptr is taken!?", 
         "Noooooo!!!!") # text
pos <- list(w = rep(0.9, 3), h = rep(0.3, 3), x = c(0.45, 0.6, 0.5),
            y = c(0.95, 0.85, 0.3)) # text position
